...
-- This version uses DO blocks (no psql meta-commands) so it runs
-- in the Supabase SQL Editor as-is.
-- Run AFTER: 001 schema, 002 indexes, 003 exclusion constraints, seeds.
